  ...
  const renderRegistrationPrintView = () => (
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        {profileData.course && (
          <div>
            <Label className="text-sm font-semibold">Primary Course</Label>
            <p className="text-sm">{profileData.course.name}</p>
          </div>
        )}
        {profileData.enrolled_courses && profileData.enrolled_courses.length > 0 && (
          <div className="col-span-2">
            <Label className="text-sm font-semibold">All Enrolled Courses</Label>
            <div className="flex flex-wrap gap-2 mt-1">
              {profileData.enrolled_courses.map((c, i) => (
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {profileData.enrolled_courses && profileData.enrolled_courses.length > 0 && (
                  <div className="col-span-1 md:col-span-2">
                    <Label className="text-sm font-semibold">Course Enrollments (All)</Label>
